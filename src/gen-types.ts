...
export type ConversionStatsResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['ConversionStats'] = ResolversParentTypes['ConversionStats']> = {
...
export type ConversionResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Conversion'] = ResolversParentTypes['Conversion']> = {
...
export type MutationResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  newConversion?: Resolver<ResolversTypes['Conversion'], ParentType, ContextType, RequireFields<MutationNewConversionArgs, 'input'>>;
};
